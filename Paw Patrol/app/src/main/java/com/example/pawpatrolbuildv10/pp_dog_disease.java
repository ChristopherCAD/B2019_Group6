    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (woof1) {
            ...
            if (woof3) {
                ...
                dog_disease6.setVisibility(View.VISIBLE);
                dog_disease7.setVisibility(View.VISIBLE);

            }
            if (woof4) {

                dog_disease2.setVisibility(View.VISIBLE);
                dog_disease5.setVisibility(View.VISIBLE);

            }
            if (woof5) {

                dog_disease2.setVisibility(View.VISIBLE);
                dog_disease4.setVisibility(View.VISIBLE);
            ...
            if (woof9) {
                ...
                dog_disease2.setVisibility(View.VISIBLE);
                dog_disease3.setVisibility(View.VISIBLE);
            ...
            // Visible CardViews include: 1, 2, and 4
