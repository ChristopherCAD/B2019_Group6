    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hamster_Search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent ham = new Intent (pp_Hamster.this, pp_hamster_disease.class);
                ...
                if (hs1.isChecked() && hs2.isChecked() && hs3.isChecked() && hs4.isChecked() && hs5.isChecked()) {
                ...
                } else if (hs1.isChecked()) {

                    ham.putExtra("hs1", hs1.isChecked());
                ...
                } else if (hs2.isChecked()) {

                    ham.putExtra("hs2", hs2.isChecked());
                ...
                } else if (hs3.isChecked()) {

                    ham.putExtra("hs3", hs3.isChecked());
                    ...
                    if (hs6.isChecked()) {
                        ...
                        ham.putExtra("hs6", hs6.isChecked());
                ...
                } else if (hs4.isChecked()) {

                    ham.putExtra("hs4", hs4.isChecked());
                ...
                } else if (hs5.isChecked()) {

                    ham.putExtra("hs5", hs5.isChecked());
                ...
                } else if (hs7.isChecked()) {

                    ham.putExtra("hs7", hs7.isChecked());
                ...
                } else if (hs8.isChecked()) {

                    ham.putExtra("hs8", hs8.isChecked());
                ...
                } else if (hs9.isChecked()) {

                    ham.putExtra("hs9", hs9.isChecked());
                ...
                } else if (hs10.isChecked()) {

                    ham.putExtra("hs10", hs10.isChecked());
                ...
                } else if (hs11.isChecked()) {

                    ham.putExtra("hs11", hs11.isChecked());
                ...
                } else if (hs12.isChecked()) {

                    ham.putExtra("hs12", hs12.isChecked());
                ...
                } else if (hs13.isChecked()) {

                    ham.putExtra("hs13", hs13.isChecked());
                ...
                } else if (hs14.isChecked()) {

                    ham.putExtra("hs14", hs14.isChecked());
                    startActivity(ham);

                } else if (hs15.isChecked()) {

                    ham.putExtra("hs15", hs15.isChecked());
                    startActivity(ham);
