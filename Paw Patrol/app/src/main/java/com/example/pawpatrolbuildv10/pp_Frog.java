    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        frog_Search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent blob = new Intent(pp_Frog.this, pp_frog_disease.class);
                ...
                } else if (fs1.isChecked()) {

                    blob.putExtra("fs1", fs1.isChecked());

                    if (fs5.isChecked()) {

                        blob.putExtra("fs5", fs5.isChecked());

                    }
                    if (fs6.isChecked()) {

                        blob.putExtra("fs6", fs6.isChecked());

                    }
                    if (fs7.isChecked()) {

                        blob.putExtra("fs7", fs7.isChecked());

                    }
                    if (fs8.isChecked()) {

                        blob.putExtra("fs8", fs8.isChecked());

                    }
                    if (fs9.isChecked()) {

                        blob.putExtra("fs9", fs9.isChecked());

                    }
                    if (fs10.isChecked()) {

                        blob.putExtra("fs10", fs10.isChecked());

                    }
                    if (fs11.isChecked()) {

                        blob.putExtra("fs11", fs11.isChecked());

                    }
                    if (fs12.isChecked()) {

                        blob.putExtra("fs12", fs12.isChecked());

                    }
                    if (fs13.isChecked()) {

                        blob.putExtra("fs13", fs13.isChecked());

                    }
                    if (fs14.isChecked()) {

                        blob.putExtra("fs14", fs14.isChecked());

                    }
                    if (fs15.isChecked()) {

                        blob.putExtra("fs15", fs15.isChecked());

                    }

                    startActivity(blob);

                } else if (fs2.isChecked()) {

                    blob.putExtra("fs2", fs2.isChecked());
                ...
                } else if (fs3.isChecked()) {

                    blob.putExtra("fs3", fs3.isChecked());
                ...
                } else if (fs4.isChecked()) {

                    blob.putExtra("fs4", fs4.isChecked());
                ...
                } else if (fs13.isChecked()) {

                    blob.putExtra("fs13", fs13.isChecked());
                    startActivity(blob);

                } else if (fs14.isChecked()) {

                    blob.putExtra("fs14", fs14.isChecked());
                    startActivity(blob);

                } else if (fs15.isChecked()) {
